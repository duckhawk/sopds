...
urlpatterns = [
    ...
    re_path(r'^collections/$', views.CollectionsView, name='collections'),
    re_path(r'^collections/new/$', views.CollectionCreate, name='collection_create'),
    re_path(r'^collections/(?P<collection_id>[0-9]+)/delete/$', views.CollectionDelete, name='collection_delete'),
    re_path(r'^collections/(?P<collection_id>[0-9]+)/share/$', views.CollectionShare, name='collection_share'),
    re_path(r'^collections/(?P<collection_id>[0-9]+)/add/(?P<book_id>[0-9]+)/$', views.CollectionAddBook, name='collection_add'),
    re_path(r'^collections/(?P<collection_id>[0-9]+)/remove/(?P<book_id>[0-9]+)/$', views.CollectionRemoveBook, name='collection_remove'),
    re_path(r'^tags/$', views.TagsView, name='tags'),
    re_path(r'^tags/(?P<book_id>[0-9]+)/add/$', views.TagAdd, name='tag_add'),
    re_path(r'^tags/(?P<book_id>[0-9]+)/remove/$', views.TagRemove, name='tag_remove'),
