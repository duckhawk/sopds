...
urlpatterns = [
    ...
    re_path(r'^collections/$',feeds.CollectionsFeed(), name='collections'),

    re_path(r'^search/$',feeds.OpenSearch, name='opensearch'),
    #re_path(r'search/{searchTerms}/$',feeds.OpenSearch, name='search_template'),

    re_path(r'^search/books/(?P<searchtype>[bmasguednxrptc])/(?P<searchterms>.+)/(?P<page>\d+)/$',feeds.SearchBooksFeed(), name='searchbooks'),
    re_path(r'^search/books/(?P<searchtype>[bmasguednxrptc])/(?P<searchterms>.+)/$',feeds.SearchBooksFeed(), name='searchbooks'),
